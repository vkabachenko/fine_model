...
class FineComponentTest extends \Codeception\Test\Unit
{

    public function testComponent2018()
    {
        ...
        $result = \Yii::$app->fine->getFine($loanAmount, $dateStart, $dateFinish, $loans, $payments, 4);
    ...
    public function testComponent2017()
    {
    ...
    public function testComponent2016()
    {
